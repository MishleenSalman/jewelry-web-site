...
if(isset($_GET['edit_products'])){
    ...
    $result_band=mysqli_query($con,$select_brand);
    $row_band=mysqli_fetch_assoc($result_band);
    $brand_title=$row_band['brand_title'];
}
...
<div class="container mt-5">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-outline w-50 m-auto mb-4">
        <label for="product_brands" class="form_label">Product Brand</label>
...
if(isset($_POST['edit_product'])){ //when we press on the update button
