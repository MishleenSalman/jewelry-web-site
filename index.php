...
<body>
    ...
    <!--THE HERO IMAGE PIC -->
    <section class="hero-image" id="top"style="
    ...
    <div class="row px-1" >
        ...
        <div class="col-md-2  p-0"style="background: white; ">
            <!-- brands -->
            <ul class="navbar-nav me-auto text-center " style="color:black;">
                <li class="nav-item ">
                    <a href="" class="nav-link"><h4 style="color: white; background-color:rgb(106, 57, 81);">Brands</h4></a>
                </li>
                <?php
                    getbrands();
                ?>
            ...
            <ul class="navbar-nav me-auto text-center">
                <li class="nav-item">
                    <a href="" class="nav-link"><h4 style="color: white; background-color:rgb(106, 57, 81);">categories</h4></a>
                </li>
                <?php
                    getcategories();
                ?>
